...
23.site:example.com ("初始密码")&("附件")

24.site:edu.cn intext:管理|后台|登陆|用户名|密码|系统|帐号|admin|login|sys|managetem|password|username

25.site:example.com 奖学金

26.site:edu.cn 公示附件

27.site:example.com xxx系统初始密码
