...
?> 后续本站也会持续更新和增加更多方向的学习路线，**Mark**一下
...
> - **最优化理论与方法**
>
>   ?>**TIPS：**必修课，2学分，\*\*\*老师讲课效果非常非常不好，如果要选这门课可以换个老师。课程难度其实也挺难的，那一本厚的书搞算法的有福了。\*你\*的\*刚考完，恶心死了，建议不要选这门课，有几年简单，但劝你不要赌。避雷。**考试重点：**等价问题转换、线性规划、几何规划、对数障碍法、KKT条件、拉格朗日对偶问题、梯度下降法、最速下降法、牛顿法、实际问题抽象为凸优化问题
>
>   - 题目
>     - [课后题](课程/凸优化/课后题)
...
> - **多媒体信息处理技术案例分析**
>
>   ?> 请企业的工程师来讲实际应用，出发点是好的。25年主要是TCL的工程师。期末要交一份从技术洞察出发的创新业务报告。
>
> - **人工智能原理**
>
>   ?>选修课，建议配合机器学习一起食用，两学分，没有考试。平时成绩占60%，考勤随机，2次平时作业、小组项目；期末成绩占40%，以课程报告的方式进行。一个小组最多4人。平时作业就是有些可以直接抄。25年做的题目之一是基于deepseek+rag增强检索+本地知识库的课程问答系统，还挺容易的，两小时左右搞定。
>
> - **基础英语**
>
>   ?> 就一句话，能免修的就免修。事情非常的多。视听说的魅力你不懂，`https://uai.unipus.cn/home`。还有itest，`https://itestcloud.unipus.cn/`。不需要开摄像头。第一次itest全是听力+后面的填词。填词比较简单，听力哥门全选C了，难崩。不过还好有加分项可以把我的垃圾听力丢的分给搞回去。还要做pre和期末考试。建议选择周**老师，直接做个人pre，只关注你的ppt的格式和字体等等，而speak是次要的。不然就选其他老师的，可能就是以小组的形式进行了。有平时作业和课堂小测，一次平时作业是300词+的个人陈述。
>
> - **论文写作指导**
>
...
> - **数据分析项目设计与实现**
>
>   ?>大课，水课。讲一下爬虫、大模型、区块链之类的
>
> - **机器学习**
>
>   ?> 大课，需要pre和平时项目，建议还是好好听
>
...
> ?>这个主要是收集一些好看的前端页面放在这里，新年祝福和生日快乐之类的页面也能在有需要的时候被用到。实验品的加密还没完成。
>
> - 前端有趣网页
