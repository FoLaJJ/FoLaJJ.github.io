...
> - **人工智能原理**
>
>   ?>选修课，建议配合机器学习一起食用，两学分，没有考试。平时成绩占60%，考勤随机，2次平时作业、小组项目；期末成绩占40%，以课程报告的方式进行。
>
> - **基础英语**
>
>   ?> 就一句话，能免修的就免修。事情非常的多。视听说的魅力你不懂，https://uai.unipus.cn/home。还有itest，https://itestcloud.unipus.cn/。不需要开摄像头。第一次itest是全是听力+后面的填词。填词比较简单，听力哥门全选C了，难崩。不过还好有加分项可以把我的垃圾听力丢的分给搞回去。还要做pre和期末考试。
>
> - **论文写作指导**
>
>   ?> 必修课，1学分，没有考试。平时成绩占30%，其中考勤占10%，最后的PPT展示占20%。期末成绩占70%，以课程报告的方式进行。就是说最后写一个综述论文的同时要将PPT做好，每个人展示3~5分钟。综述还是一样，自己研究的内容方向。
>
> - **数据分析项目设计与实现**
>
>   ?> 应该全是请企业的工程师来讲实际应用，出发点是好的。
>
> - **机器学习**
>
>   ?> 水课，大课，需要pre和平时项目
